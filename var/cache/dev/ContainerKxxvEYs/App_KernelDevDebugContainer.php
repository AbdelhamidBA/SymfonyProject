...
class App_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.errored..service_locator.hu2tz9i.Doctrine\Persistence\ObjectManager' shared service.
     *
     * @return \Doctrine\Persistence\ObjectManager
     */
    protected function getObjectManagerService()
    {
        $this->throw('Cannot autowire service ".service_locator.hu2tz9i": it references interface "Doctrine\\Persistence\\ObjectManager" but no such service exists. You should maybe alias this interface to the existing "doctrine.orm.default_entity_manager" service.');
    }

    /**
     * Gets the private '.service_locator.2wty8dM' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_2wty8dMService()
    {
        return $this->privates['.service_locator.2wty8dM'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\AuthenticationController::registration' => ['privates', '.service_locator.hu2tz9i', 'get_ServiceLocator_Hu2tz9iService', false],
            'App\\Controller\\AuthenticationController:registration' => ['privates', '.service_locator.hu2tz9i', 'get_ServiceLocator_Hu2tz9iService', false],
        ], [
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.2wty8dM'] ?? $this->get_ServiceLocator_2wty8dMService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getSecurity_Command_UserPasswordEncoderService()
    {
        ...
        $this->privates['security.command.user_password_encoder'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\UserPasswordEncoderCommand(($this->privates['security.encoder_factory.generic'] ?? $this->getSecurity_EncoderFactory_GenericService()), [0 => 'App\\Entity\\Client']);
    ...
    protected function getSecurity_EncoderFactory_GenericService()
    {
        ...
        return $this->privates['security.encoder_factory.generic'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(['App\\Entity\\Client' => ['class' => 'Symfony\\Component\\Security\\Core\\Encoder\\NativePasswordEncoder', 'arguments' => [0 => NULL, 1 => NULL, 2 => NULL, 3 => '2y']]]);
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InDatabaseService()
    {
        ...
        return $this->privates['security.user.provider.concrete.in_database'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\Client', 'email,username', NULL);
    }
